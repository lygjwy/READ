...
from trainers import get_deconf_trainer
...
def main(args):
    ...
    trainer = get_deconf_trainer(deconf_net, train_loader, optimizer, h_optimizer, scheduler, h_scheduler)
    ...
    for epoch in range(start_epoch, args.epochs+1):
        ...
        trainer.train_epoch()
        val_metrics = evaluator.eval_deconf_classification(test_loader)
